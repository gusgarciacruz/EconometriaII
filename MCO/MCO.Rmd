...
- <span style="font-size:150%"> [<span style="color:black">Ejercicio aplicado en R: tasas de retorno a la educación](#r)</span> <br> <br>

- <span style="font-size:150%"> [<span style="color:black">Ejercicio aplicado en Python: tasas de retorno a la educación](#py)</span>
...
---
name: py
# <span style="font-size:80%">Ejercicio aplicado en Python: tasas de retorno a la educación</span>

En el siguiente link se puede descagar el código en Python: [MCO.py](https://gusgarciacruz.github.io/EconometriaII/MCO/MCO.py)

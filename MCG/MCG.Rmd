...
- <span style="font-size:150%"> [<span style="color:black">Ejercicio aplicado en R: heteroscedasticidad](#r)</span> <br> <br>

- <span style="font-size:150%"> [<span style="color:black">Ejercicio aplicado en Python: heteroscedasticidad](#py)</span>
...
---
name: py
# <span style="font-size:80%">Ejercicio aplicado en Python: heteroscedasticidad</span>

En el siguiente link se puede descagar el código en Python: [MCG.py](https://gusgarciacruz.github.io/EconometriaII/MCO/MCG.py)

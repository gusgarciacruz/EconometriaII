...
<p style="margin-bottom: -0.6em">
- El trabajo se debe llevar a cabo en grupos máximo de **3 estudiantes**
<p style="margin-bottom: -0.6em">
...
- Puede ser entregar en documento Word (máx 15 pág), Latex (máx 15 pág) o Blog de [Rmarkdown](https://datacarpentry.org/r-socialsci/05-rmarkdown/index.html)
...
**<span style="color:red">El trabajo debe ser entregado y presentado el martes 7 de mayo**

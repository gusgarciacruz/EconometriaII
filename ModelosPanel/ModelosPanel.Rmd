...
- <span style="font-size:150%">[<span style="color:black">Generalidades](#generalidades)</span>

- <span style="font-size:150%">[<span style="color:black">Tipos de paneles](#tipos)</span>

- <span style="font-size:150%">[<span style="color:black">Técnicas de estimación](#tecnicas)</span>

- <span style="font-size:150%">[<span style="color:black">Modelo de MCO agrupados (*Pooling*)](#pool)</span>

- <span style="font-size:150%">[<span style="color:black">Modelo efectos fijos: MCO con variable dicótoma (MCVD)](#ef)</span>

- <span style="font-size:150%">[<span style="color:black">Modelo efectos fijos: estimador intragrupal (*Within*)](#within)</span>

- <span style="font-size:150%">[<span style="color:black">Modelo de efectos aleatorios](#ea)</span>

- <span style="font-size:150%">[<span style="color:black">FE vs RE: algunos lineamientos](#lineamientos)</span>

- <span style="font-size:150%">[<span style="color:black">FE vs RE: qué dice Wooldridge](#wool)</span>

- <span style="font-size:150%">[<span style="color:black">Ejercicio aplicado en R: función de costos de líneas de aviación](#r)</span>
...
---
name: r
# <span style="font-size:80%">Ejercicio aplicado: función de costos de líneas de aviación</span>
<font size = "5">
